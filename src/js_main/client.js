...
function connect() {
    ...
    if (ws) {
        // avoid re-run connect() function but having two instant socket connection
    ...
    ws = new WebSocket("ws://192.168.31.213:3000/?token=" + client_name); // create a socket
    ...
    ws.onmessage = function (message) {
        ...
        if (message.data.split(" ")[0] == "Verified") {
            ...
            // if server refuse client's connection
